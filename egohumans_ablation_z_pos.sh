...
#SBATCH --error=/home/hongsuk/projects/dust3r/jobs/jobs9/%j_%t_%A_%a_log.err           # Error file
#SBATCH --output=/home/hongsuk/projects/dust3r/jobs/jobs9/%j_%t_%A_%a_log.out         # Output file
...
if [ $use_gt_focal = True ]; then
    ...
    cmd="CUDA_VISIBLE_DEVICES=0 python hongsuk_egohumans_align_dust3r_hmr2hamer_pos_z.py --num-of-cams 4 --sel-big-seqs $big_seq --sel_small_seq_range $small_seq --use_gt_focal --dust3r_raw_output_dir $dust3r_raw_output_dir --dust3r_ga_output_dir $dust3r_ga_output_dir"
else
    cmd="CUDA_VISIBLE_DEVICES=0 python hongsuk_egohumans_align_dust3r_hmr2hamer_pos_z.py --num-of-cams 4 --sel-big-seqs $big_seq --sel_small_seq_range $small_seq --dust3r_raw_output_dir $dust3r_raw_output_dir --dust3r_ga_output_dir $dust3r_ga_output_dir"
fi
