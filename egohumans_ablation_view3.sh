...
#SBATCH --error=/home/hongsuk/projects/dust3r/jobs/jobs10/%j_%t_%A_%a_log.err           # Error file
#SBATCH --output=/home/hongsuk/projects/dust3r/jobs/jobs10/%j_%t_%A_%a_log.out         # Output file
...
#SBATCH --qos=medium
#SBATCH --array=0-7
#SBATCH --comment="egohumans num human ablation"
...
IFS=$'\r\n' GLOBIGNORE='*' command eval  'PREFIXES=($(cat ./egohumans_subset_slurm_pred_focal.txt))' # 66
...
dust3r_raw_output_dir='/scratch/partial_datasets/egoexo/hongsuk/egohumans/dust3r_raw_outputs/2024nov16_name_uniform_cams'
dust3r_ga_output_dir='/scratch/partial_datasets/egoexo/hongsuk/egohumans/dust3r_ga_outputs_and_gt_cameras/2024nov16_name_uniform_cams'
...
if [ $use_gt_focal = True ]; then
    ...
    cmd="CUDA_VISIBLE_DEVICES=0 python hongsuk_egohumans_align_dust3r_hmr2hamer.py --num-of-cams 3 --sel-big-seqs $big_seq --sel_small_seq_range $small_seq --use_gt_focal --dust3r_raw_output_dir $dust3r_raw_output_dir --dust3r_ga_output_dir $dust3r_ga_output_dir"
else
    cmd="CUDA_VISIBLE_DEVICES=0 python hongsuk_egohumans_align_dust3r_hmr2hamer.py --num-of-cams 3 --sel-big-seqs $big_seq --sel_small_seq_range $small_seq --dust3r_raw_output_dir $dust3r_raw_output_dir --dust3r_ga_output_dir $dust3r_ga_output_dir"
fi
