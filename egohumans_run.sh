...
#SBATCH --error=/home/hongsuk/projects/dust3r/jobs1/%j_%t_%A_%a_log.err           # Error file
#SBATCH --output=/home/hongsuk/projects/dust3r/jobs1/%j_%t_%A_%a_log.out         # Output file
