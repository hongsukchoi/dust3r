...
def main(output_dir: str = './outputs/egohumans/', dust3r_raw_output_dir: str = './outputs/egohumans/dust3r_raw_outputs/2024nov16_name_uniform_cams', egohumans_data_root: str = './data/egohumans_data', vis: bool = False):
    ...
    selected_small_seq_start_and_end_idx_tuple = None # (1, 20) # (6,13) 
    ...
    output_dir = osp.join(output_dir, 'dust3r_ga_outputs_and_gt_cameras', '2024nov16_name_uniform_cams', f'num_of_cams{num_of_cams}')
