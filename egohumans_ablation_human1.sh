...
dust3r_raw_output_dir='/scratch/partial_datasets/egoexo/hongsuk/egohumans/dust3r_raw_outputs/2024nov13_good_cams'
dust3r_ga_output_dir='/scratch/partial_datasets/egoexo/hongsuk/egohumans/dust3r_ga_outputs_and_gt_cameras/2024nov13_good_cams'
...
if [ $use_gt_focal = True ]; then
    ...
    cmd="CUDA_VISIBLE_DEVICES=0 python hongsuk_egohumans_align_dust3r_hmr2hamer.py --num-of-cams 4 --num_human_optim 1 --sel-big-seqs $big_seq --sel_small_seq_range $small_seq --use_gt_focal --dust3r_raw_output_dir $dust3r_raw_output_dir --dust3r_ga_output_dir $dust3r_ga_output_dir"
else
    cmd="CUDA_VISIBLE_DEVICES=0 python hongsuk_egohumans_align_dust3r_hmr2hamer.py --num-of-cams 4 --num_human_optim 1 --sel-big-seqs $big_seq --sel_small_seq_range $small_seq --dust3r_raw_output_dir $dust3r_raw_output_dir --dust3r_ga_output_dir $dust3r_ga_output_dir"
fi
