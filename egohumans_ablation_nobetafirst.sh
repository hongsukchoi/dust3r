...
if [ $use_gt_focal = True ]; then
    ...
    cmd="CUDA_VISIBLE_DEVICES=0 python hongsuk_egohumans_align_dust3r_hmr2hamer_nobetafirst.py --num-of-cams 4 --sel-big-seqs $big_seq --sel_small_seq_range $small_seq --use_gt_focal --dust3r_raw_output_dir $dust3r_raw_output_dir --dust3r_ga_output_dir $dust3r_ga_output_dir"
else
    cmd="CUDA_VISIBLE_DEVICES=0 python hongsuk_egohumans_align_dust3r_hmr2hamer_nobetafirst.py --num-of-cams 4 --sel-big-seqs $big_seq --sel_small_seq_range $small_seq --dust3r_raw_output_dir $dust3r_raw_output_dir --dust3r_ga_output_dir $dust3r_ga_output_dir"
fi
